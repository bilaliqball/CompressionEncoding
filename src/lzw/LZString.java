...
try {
Writer out = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file),StandardCharsets.UTF_16));
out.append(content);
out.flush();
out.close();} 
catch (UnsupportedEncodingException e) {System.out.println(e.getMessage());} 
...
//LZW
//FileInputStream fis=new FileInputStream(new File("C:\\Users\\bilal.iqbal\\Pictures\\FILES\\sample\\inp.txt"));
//String input = readContent(fis);System.out.println("Uncompressed"+ input.length());
//String compress ="";
//compress=LZString.compress(input);System.out.println("Compressed: " + compress.length());
//writes(new File("C:\\Users\\bilal.iqbal\\Pictures\\FILES\\sample\\comp.bin"),compress);
//compress = reads(new File("C:\\Users\\bilal.iqbal\\Pictures\\FILES\\sample\\comp.bin"));System.out.println("Uncompressed"+ compress.length());
//String decompress = LZString.decompress(compress);System.out.println("Decompressed: " + decompress.length());
//write(new File("C:\\Users\\bilal.iqbal\\Pictures\\FILES\\sample\\dec.bin"),decompress);
...
//String testUTF16  = readContent(fis);System.out.println("Uncompressed"+ testUTF16.length());
//String outputUTF16 = LZString.compressToUTF16(testUTF16);System.out.println("Compressed: " + outputUTF16.length());writes(new File("C:\\Users\\bilal.iqbal\\Pictures\\FILES\\sample\\comp.bin"),outputUTF16);
//outputUTF16 = read(new File("C:\\Users\\bilal.iqbal\\Pictures\\FILES\\sample\\comp.bin"));System.out.println("Uncompressed"+ outputUTF16.length());
//String decompressedUTF16 = LZString.decompressFromUTF16(outputUTF16);System.out.println("Decompressed: " + decompressedUTF16.length());writes(new File("C:\\Users\\bilal.iqbal\\Pictures\\FILES\\sample\\decomp.bin"),decompressedUTF16);
...
//String content = read(new File("C:\\Users\\bilal.iqbal\\Pictures\\FILES\\sample\\inp.txt"));
//writes(new File("C:\\Users\\bilal.iqbal\\Pictures\\FILES\\sample\\decomp.bin"),content);
	

//Base64

FileInputStream fis=new FileInputStream(new File("C:\\Users\\bilal.iqbal\\Pictures\\FILES\\sample\\hex.bin"));
String testBase64  = readContent(fis);System.out.println("Uncompressed"+ testBase64.length());
String outputBase64 = LZString.compressToBase64(testBase64);System.out.println("Compressed: " + outputBase64.length());write(new File("C:\\Users\\bilal.iqbal\\Pictures\\FILES\\sample\\comp.txt"),outputBase64);
String compress = reads(new File("C:\\Users\\bilal.iqbal\\Pictures\\FILES\\sample\\comp.bin"));System.out.println("Uncompressed"+ compress.length());
String decompressedBase64 = LZString.decompressFromBase64(outputBase64);System.out.println("Decompressed: " + decompressedBase64.length());write(new File("C:\\Users\\bilal.iqbal\\Pictures\\FILES\\sample\\decomp.txt"),decompressedBase64);
  }
}
