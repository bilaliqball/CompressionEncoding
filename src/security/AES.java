...
Key key = generateKey();final String ALGO = "AES";
...
String str="Hello how are you?";str="howtodoinjava.com";
String enc=encrypt(str);System.out.println(enc);
String dec=decrypt(enc);System.out.println(dec);
if(str.equals(dec)) {System.out.println("Equals");}
